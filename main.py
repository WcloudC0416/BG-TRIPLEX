...
from models import BG_TRIPLEX, CustomWriter
...
def get_parse():
    ...
    parser.add_argument('--config_name', type=str, default='her2st/BG_TRIPLEX', help='logger path.')
    ...
    parser.add_argument('--model_path', type=str, default='logs/2024-04-10/0-BG_TRIPLEX-her2st-2021-3/0-BG_TRIPLEX-her2st-2021-3-epoch=20-valid_loss=0.3268-R=0.1917.ckpt', help='')
